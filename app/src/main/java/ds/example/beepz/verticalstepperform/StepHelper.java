...
import ds.example.beepz.verticalstepperform.VerticalStepperFormView.FormStyle;
 ...
 */
class StepHelper implements ds.example.beepz.verticalstepperform.Step.InternalFormStepListener {

    private ds.example.beepz.verticalstepperform.Step<?> step;
    ...
    StepHelper(ds.example.beepz.verticalstepperform.Step.InternalFormStepListener formListener, @NonNull ds.example.beepz.verticalstepperform.Step<?> step) {
        this(formListener, step, false);
    }

    StepHelper(ds.example.beepz.verticalstepperform.Step.InternalFormStepListener formListener, ds.example.beepz.verticalstepperform.Step<?> step, boolean isConfirmationStep) {
    ...
    private void setupStepViews(final VerticalStepperFormView form, View stepLayout) {
        ...
        if (step.getContentLayout() != null) {
            ViewGroup contentContainerLayout = step.getEntireStepLayout().findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_content);
            contentContainerLayout.addView(step.getContentLayout());
        }

        stepNumberCircleView = stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_number_circle);
        stepNumberTextView = stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_number);
        titleView = stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_title);
	//titleView.setVisibility(View.GONE);
        subtitleView = stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_subtitle);
        doneIconView = stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_done_icon);
        errorMessageView = stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_error_message);
        errorIconView = stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_error_icon);
        headerView = stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_header);
        nextButtonView = stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_button);
        cancelButtonView = stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_cancel_button);
        lineView1 = stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.line1);
        lineView2 = stepLayout.findViewById(ernestoyaquello.com.verticalstepperform.R.id.line2);
        stepAndButtonView = step.getEntireStepLayout().findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_content_and_button);
        errorMessageContainerView = step.getEntireStepLayout().findViewById(ernestoyaquello.com.verticalstepperform.R.id.step_error_container);
        titleAndSubtitleContainerView = step.getEntireStepLayout().findViewById(ernestoyaquello.com.verticalstepperform.R.id.title_subtitle_container);
        errorContentAndButtonContainerView = step.getEntireStepLayout().findViewById(ernestoyaquello.com.verticalstepperform.R.id.error_content_button_container);
        ...
        Drawable circleDrawable = ContextCompat.getDrawable(form.getContext(), ernestoyaquello.com.verticalstepperform.R.drawable.circle_step_done);
        ...
        ds.example.beepz.verticalstepperform.UIHelper.setButtonColor(
                nextButtonView,
    ...
    public ds.example.beepz.verticalstepperform.Step<?> getStepInstance() {
        return step;
    }
    ...
    public void onUpdatedStepVisibility(int stepPosition, boolean useAnimations) {
        if (step.getEntireStepLayout() != null) {
            if (step.isOpen()) {
                ds.example.beepz.verticalstepperform.UIHelper.slideDownIfNecessary(stepAndButtonView, useAnimations);
                ...
                ds.example.beepz.verticalstepperform.UIHelper.slideUpIfNecessary(stepAndButtonView, useAnimations);
                updateHeader(useAnimations);
            }
        }
    }
    ...
    private void updateSubtitleVisibility(boolean useAnimations) {
        ...
        if (showSubtitle) {
            ds.example.beepz.verticalstepperform.UIHelper.slideDownIfNecessary(subtitleView, useAnimations);
        } else {
            ds.example.beepz.verticalstepperform.UIHelper.slideUpIfNecessary(subtitleView, useAnimations);
        }
    }
    ...
    private void updateErrorMessageVisibility(boolean useAnimations) {
        if (step.isOpen() && !step.isCompleted() && !step.getErrorMessage().isEmpty()) {
            ds.example.beepz.verticalstepperform.UIHelper.slideDownIfNecessary(errorMessageContainerView, useAnimations);
        } else {
            ds.example.beepz.verticalstepperform.UIHelper.slideUpIfNecessary(errorMessageContainerView, useAnimations);
        }
    }
